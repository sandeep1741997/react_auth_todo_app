                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <Form.Control as="textarea" rows={3} type="text" name="text" id="text" value={this.state.text}
                                    onChange={this.handleOnChange} placeholder="Add a note" width="80%" />
                            </div>
                            <div className="col-md-2">
                                <Button onClick={this.createTodo}>Add Todo</Button><br></br><br></br>
                                <Button onClick={this.clearText} style={{}}>Clear</Button>
                            </div>
                            <ToastContainer />
                        </div>
                    </div>
                ...
                <div style={{ alignItems: 'center' }}>
                    {
                        this.state.todoList.map((item, idx) => <div key={idx}style={{
                            ...
                            <Badge pill variant="primary" style={{ padding: 20 }}>{idx + 1}</Badge>
